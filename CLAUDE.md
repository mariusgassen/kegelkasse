...
| 17 | **Logging**                        | ✅      | Python stdlib logging mit LOG_LEVEL env-var (config.py); logging.basicConfig in main.py; strukturierte Logger in auth, evenings, scheduler; 5xx-Middleware-Logging |
