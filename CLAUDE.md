...
| 34 | **Kommentare & Reaktionen**        | ✅      | Kollabierbare Kommentar-Threads auf Highlights und Ankündigungen; Emoji-Reaktionen pro Kommentar (Toggle-Picker); Soft-Delete mit Bestätigung; Kommentare bearbeiten (edited_at); Antworten (max Tiefe 1) mit @-Erwähnung; Kommentarzähler immer sichtbar; Migration 042+044 (comment, comment_reaction, item_reaction, parent_comment_id, edited_at); pytest: 28+ Tests |
...
| 36 | **Item-Reaktionen**                | ✅      | Emoji-Reaktionen direkt auf Highlights und Ankündigungen (nicht nur auf Kommentaren); ItemReactionBar-Komponente; POST /comments/item-reaction/{type}/{id}; Migration 044 (item_reaction-Tabelle) |
