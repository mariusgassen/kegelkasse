...
| 29 | **Tablet Schnellerfassung**        | ✅      | Vollbild-Overlay (⚡) für Landscape-Modus; 3-Spalten-Layout: Spieler (Auswahl) \| Strafen \| **Übersicht pro Spieler** (Strafen-€-Summe inkl. Gäste-Cap, Spiel-Score live aus letztem Wurf, Getränke-Counts, Plausibilitäts-Check + Gesamtsumme im Footer); iOS safe-area-insets (Notch, Home-Indicator, gerundete Ecken); kein Scrollen erforderlich; letzte Einträge unten; 0€-Strafen ausgeblendet; Strafen-Buttons vergrößert. Getränke-Spalte entfernt → `🍺 Runde`-CTA im Header öffnet Bottom-Sheet (Drink-First-Flow: Bier/Schnaps wählen → Teilnehmer multi-select; Auswahl aus Spalte 1 übernehmbar). Übersicht-Spalte nach Strafen-€ absteigend sortiert mit FLIP-Reorder-Animation. |
