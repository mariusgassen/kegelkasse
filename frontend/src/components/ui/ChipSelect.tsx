      ...
      {(label || onSelectAll || onSelectNone) && (
        <div className="flex items-center mb-1.5">
          ...
          <div className="ml-auto flex gap-1.5">
            {onSelectAll  && <button type="button" className="btn-secondary btn-xs" onClick={onSelectAll}>Alle</button>}
            {onSelectNone && <button type="button" className="btn-secondary btn-xs" onClick={onSelectNone}>Keine</button>}
          </div>
        </div>
      )}
